...
| B10 offensive projection | PARTIAL | Paired strategic destroyer+tanker+repair packages now derive fitted/deployed mass, common paid-FTL travel time/energy, finite tanker reaction-mass support, an explicit overextension boundary and an actor-bounded route assessment from the real Stage-22 engineering catalog. Campaign movement/order execution and replenishment consumption still need to exercise the same envelope before B10 can be COMPLETE. |
