...
/** Composes M22.4 Union modules and M22.6 exact ammunition into the existing Stage-18 manufacturing authority. */
public final class Stage22IndustrialUnionManufacturingCatalogLoader {
    private Stage22IndustrialUnionManufacturingCatalogLoader() {
    ...
    public static Stage18ManufacturingCatalog loadDefault() {
        return Stage22AuthoredProductionBridge.withManufacturingContent(
                ...
                List.of(
                        binding("ammo.industrial_union_dart_140kg_v1", "manufacturing.profile.kinetic_ammunition"),
    ...
    private static ProductBindingDefinition binding(String product, String profile) {
        return new ProductBindingDefinition(product, profile);
    }
}
