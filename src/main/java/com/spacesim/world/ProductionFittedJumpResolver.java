 ...
 * catalog that can interpret the fitted hull/modules, delegates FTL planning and commit to that
 * catalog's {@link ShipEngineeringRuntime}, and always plans against the current physical module
 * damage. Unknown or ambiguous fitted content fails closed. Stage-10 legacy fleets without an
 * {@link EngineeringComponent} never enter this resolver.</p>
 */
